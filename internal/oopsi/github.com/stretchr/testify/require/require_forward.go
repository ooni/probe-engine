/*
* CODE GENERATED AUTOMATICALLY WITH github.com/ooni/probe-engine/internal/oopsi/github.com/stretchr/testify/_codegen
...
import (
	assert "github.com/ooni/probe-engine/internal/oopsi/github.com/stretchr/testify/assert"
	http "net/http"
	url "net/url"
	time "time"
)
