...
import (
	...
	"github.com/ooni/probe-engine/internal/oopsi/golang.org/x/tools/go/packages"
)
...
func main() {
	...
	pkg, err := loadModule("github.com/ooni/probe-engine/internal/oopsi/github.com/miekg/dns")
	fatalIfErr(err)
	scope := pkg.Scope()
