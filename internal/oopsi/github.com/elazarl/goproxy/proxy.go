...
type ProxyHttpServer struct {
	...
	// see http://github.com/ooni/probe-engine/internal/oopsi/golang.org/src/pkg/sync/atomic/doc.go#L41
	sess int64
...
func removeProxyHeaders(ctx *ProxyCtx, r *http.Request) {
	...
	// https://github.com/ooni/probe-engine/internal/oopsi/github.com/golang/go/blob/master/src/net/http/request.go#L1080
	// Later, transfer.go adds "Connection: close" back when req.Close is true
	// https://github.com/ooni/probe-engine/internal/oopsi/github.com/golang/go/blob/master/src/net/http/transfer.go#L275
