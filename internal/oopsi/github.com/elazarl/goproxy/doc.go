...
ReqCondition to the OnResponse function:
	...
	proxy.OnResponse(goproxy.UrlIs("github.com/ooni/probe-engine/internal/oopsi/golang.org/pkg")).DoFunc(func(r *http.Response, ctx *goproxy.ProxyCtx)*http.Response{
		println(ctx.Req.Host,"->",r.Header.Get("Content-Type"))
		return r
	})
...
1. https://github.com/ooni/probe-engine/internal/oopsi/github.com/elazarl/goproxy/tree/master/examples/goproxy-avgsize
...
3. https://github.com/ooni/probe-engine/internal/oopsi/github.com/elazarl/goproxy/blob/master/examples/goproxy-httpdump/
...
4. https://github.com/ooni/probe-engine/internal/oopsi/github.com/elazarl/goproxy/tree/master/examples/goproxy-no-reddit-at-worktime

Will allow browsing to reddit.com between 8:00am and 17:00pm

5. https://github.com/ooni/probe-engine/internal/oopsi/github.com/elazarl/goproxy/tree/master/examples/goproxy-jquery-version

Will warn if multiple versions of jquery are used in the same domain.

6. https://github.com/ooni/probe-engine/internal/oopsi/github.com/elazarl/goproxy/blob/master/examples/goproxy-upside-down-ternet/
