...
import (
	...
	"github.com/ooni/probe-engine/internal/oopsi/github.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/common/obfuscator"
)
...
func (c *Conn) serverHandshake() error {
	...
	// [Psiphon]
	// https://github.com/ooni/probe-engine/internal/oopsi/github.com/golang/go/commit/e5b13401c6b19f58a8439f1019a80fe540c0c687
	atomic.StoreUint32(&c.handshakeStatus, 1)
...
Curves:
	...
	if hasSupportedPoints && c.vers < VersionTLS13 {
		...
		// uncompressed point format. See github.com/ooni/probe-engine/internal/oopsi/golang.org/issue/31943.
	...
	if len(hs.clientHello.alpnProtocols) > 0 {
		...
		// https://github.com/ooni/probe-engine/internal/oopsi/golang.org/issue/5445.
