...
import (
	...
	"github.com/ooni/probe-engine/internal/oopsi/github.com/Psiphon-Labs/chacha20/internal/subtle"
)
...
func (s *Cipher) XORKeyStream(dst, src []byte) {
	...
	for i := 0; i < n; i += 64 {
		...
		if s.counter == 0 {
			...
			// overflow logic:
			// https://github.com/ooni/probe-engine/internal/oopsi/github.com/openssl/openssl/blob/706457b7bda7fdbab426b8dce83b318908339da4/crypto/evp/e_chacha20_poly1305.c#L94-L104.
