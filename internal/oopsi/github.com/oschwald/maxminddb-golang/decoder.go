...
// https://github.com/ooni/probe-engine/internal/oopsi/golang.org/LICENSE
...
func (d *decoder) decodeStruct(
	...
	for i := uint(0); i < size; i++ {
		...
		// optimization: https://github.com/ooni/probe-engine/internal/oopsi/github.com/golang/go/issues/3512
...
// can take advantage of https://github.com/ooni/probe-engine/internal/oopsi/github.com/golang/go/issues/3512 to avoid
