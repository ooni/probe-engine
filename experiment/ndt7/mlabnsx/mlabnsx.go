// Package mlabnsx is a fork of the mlabns bundled with the
// reference ndt7 client that is more flexible. We'll see to
// merge these changes back into mainline.
package mlabnsx
